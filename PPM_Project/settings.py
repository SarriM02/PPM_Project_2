...
SECRET_KEY = 'django-insecure-&qzh(*9s^h98&o&m!1(wh2h@w_7aggydvpo8z(i+w3km0(#0ox'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'PPM_App/../PPM_App/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'PPM_App/static']
